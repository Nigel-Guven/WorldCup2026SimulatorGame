...
export function MatchdayTabs({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 flex space-x-1 bg-slate-900/80 p-1 rounded-xl border border-slate-800/80 overflow-x-auto scrollbar-none">
